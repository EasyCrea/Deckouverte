...
const ReignsGame = () => {
  ...
  const handleStateChange = ({ nativeEvent }) => {
    if (nativeEvent.state === State.END) {
      const choice = nativeEvent.translationX > 100 ? 'left' : 
                     nativeEvent.translationX < -100 ? 'right' : null;
      ...
      >
        ...
        <>
          <View style={styles.scoreContainer}>
            <Text style={styles.scoreText}>Population: {gameStates.people}</Text>
            <Text style={styles.scoreText}>Finances: {gameStates.treasury}</Text>
            ...
            {[
              ...
              <View key={key} style={styles.indicatorContainer}>
                ...
                <View style={styles.progressBarBackground}>
                  <View style={[styles.progressBarForeground, { width: `${(gameStates[key] / 200) * 100}%` }]} />
                </View>
              </View>
            ))}
          </View>
